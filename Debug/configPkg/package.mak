...
C:/ti/pdk_omap138_1_0_8/packages/ti/build/omapl138/config_omapl138_c674x.bld:
package.mak: C:/ti/pdk_omap138_1_0_8/packages/ti/build/omapl138/config_omapl138_c674x.bld
...
ti.targets.elf.C674.rootDir ?= C:/ti/ti-cgt-c6000_8.3.2
...
.dlls,e674 .dlls: usb_c674x_omapl138.pe674

-include package/cfg/usb_c674x_omapl138_pe674.mak
-include package/cfg/usb_c674x_omapl138_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/usb_c674x_omapl138_pe674.dep
endif
usb_c674x_omapl138.pe674: package/cfg/usb_c674x_omapl138_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
usb_c674x_omapl138.pe674 package/cfg/usb_c674x_omapl138_pe674.c: .libraries,e674
endif

package/cfg/usb_c674x_omapl138_pe674.c package/cfg/usb_c674x_omapl138_pe674.h package/cfg/usb_c674x_omapl138_pe674.xdl: override _PROG_NAME := usb_c674x_omapl138.xe674
package/cfg/usb_c674x_omapl138_pe674.c package/cfg/usb_c674x_omapl138_pe674.xdl: override _PROG_XSOPTS = -DBOARD=lcdkOMAPL138
package/cfg/usb_c674x_omapl138_pe674.c: package/cfg/usb_c674x_omapl138_pe674.cfg
package/cfg/usb_c674x_omapl138_pe674.xdc.inc: package/cfg/usb_c674x_omapl138_pe674.xdl
package/cfg/usb_c674x_omapl138_pe674.xdl package/cfg/usb_c674x_omapl138_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/usb_c674x_omapl138_pe674.cfg
	-$(RM) package/cfg/usb_c674x_omapl138_pe674.dep
	-$(RM) package/cfg/usb_c674x_omapl138_pe674.c
	-$(RM) package/cfg/usb_c674x_omapl138_pe674.xdc.inc

clean,e674::
	-$(RM) usb_c674x_omapl138.pe674
.executables,e674 .executables: usb_c674x_omapl138.xe674

usb_c674x_omapl138.xe674: |usb_c674x_omapl138.pe674

-include package/cfg/usb_c674x_omapl138.xe674.mak
usb_c674x_omapl138.xe674: package/cfg/usb_c674x_omapl138_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/usb_c674x_omapl138_pe674.oe674   package/cfg/usb_c674x_omapl138_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
usb_c674x_omapl138.xe674: export C_DIR=
usb_c674x_omapl138.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
usb_c674x_omapl138.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

usb_c674x_omapl138.test test,e674 test: usb_c674x_omapl138.xe674.test

usb_c674x_omapl138.xe674.test:: usb_c674x_omapl138.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 usb_c674x_omapl138.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.usb_c674x_omapl138.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,usb_c674x_omapl138.xe674,*)


clean:: clean,e674

clean,e674::
	-$(RM) usb_c674x_omapl138.xe674
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
usb_c674x_omapl138_pe674.oe674,copy : package/cfg/usb_c674x_omapl138_pe674.oe674
usb_c674x_omapl138_pe674.se674,copy : package/cfg/usb_c674x_omapl138_pe674.se674
